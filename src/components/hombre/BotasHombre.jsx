                        ...
                        >
                            ...
                            {isAdmin && (
                                <div className="mt-4 flex justify-between">
                                    <Button size="sm" color="blue" onClick={(e) => { e.stopPropagation(); handleOpenEdit("BotasYBotinesHombre", zapatoBota); }}>Edit</Button>
                                    <Button size="sm" color="red" onClick={(e) => { e.stopPropagation(); deleteTableData("BotasYBotinesHombre", zapatoBota.id); }}>Delete</Button>
                                </div>
                            )}
                        </div>
                    ))}
                ...
                <Card className="dark:bg-blue-gray-900 dark:text-white mx-auto w-full max-w-[24rem]">
                    <form onSubmit={(e) => {
                        ...
                        <CardBody className="flex flex-col gap-4">
                            <Typography variant="h4">{editData ? 'Actualizar Botas' : 'Añadir Botas Nuevas'}</Typography>
                            <Input
                                label="Nombre"
                                size="lg"
                                color="blue-gray"
                        ...
                        <CardFooter className="pt-0">
                            <Button variant="gradient" fullWidth type="submit">
                                {editData ? 'Actualizar Botas' : 'Añadir Botas'}
                            </Button>
                        </CardFooter>
                    </form>
                </Card>
