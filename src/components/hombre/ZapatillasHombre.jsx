...
export function ZapatillasHombre() {
    ...
    return (
        <div className="container mx-auto py-20 pb-16">
            <h1 className="dark:text-white text-blue-gray-800 text-3xl font-bold mb-4">Zapatillas para Hombre</h1>
            {zapass.length === 0 ? (
                <p className="text-blue-gray-600 dark:text-blue-gray-100">No hay zapatillas disponibles</p>
            ) : (
                        ...
                        >
                            ...
                            {isAdmin && (
                                <div className="mt-4 flex justify-between">
                                    <Button size="sm" color="blue" onClick={(e) => { e.stopPropagation(); handleOpenEdit("ZapatillasHombre", zapatoBota); }}>Edit</Button>
                                    <Button size="sm" color="red" onClick={(e) => { e.stopPropagation(); deleteTableData("ZapatillasHombre", zapatoBota.id); }}>Delete</Button>
                                </div>
                            )}
                        </div>
                    ))}
            ...
            {isAdmin && (
                <div className="absolute bottom-20 right-4">
                    <Button onClick={handleOpenPut} variant="gradient">Añadir Zapatillas</Button>
                </div>
            )}
