...
const handleUpdateProfile = async () => {
  ...
  try {
    const response = await fetch("https://laszapas.vercel.app/api/update-user", {
      method: "POST",
    ...
    // 🚀 **Forzar actualización de sesión en Supabase**
    const { data, error } = await supabase.auth.refreshSession();
    if (error) throw error;

    // Actualizar el estado de la sesión con los nuevos datos
